...
showHtml msg = case msg of
    Error s -> div [ class "popup-msg err-msg noselect" ] [ toHtml (formatForDiv s) ]
    Output s-> div [ class "popup-msg out-msg noselect" ] [ toHtml (formatForDiv s) ]
    Ignore  -> div [ class "popup-msg remove-msg" ] []